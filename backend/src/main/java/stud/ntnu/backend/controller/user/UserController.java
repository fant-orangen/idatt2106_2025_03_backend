...
public class UserController {
     ...
     */
    @PutMapping("/me")
    public ResponseEntity<UserProfileDto> updateCurrentUser(@RequestBody UserUpdateDto userUpdateDto) {
    ...
    public ResponseEntity<UserProfileDto> updateUserPreferences(@RequestBody UserPreferencesDto preferencesDto) {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        String email = authentication.getName();
    ...
    /**
     * Retrieves the complete history of the currently authenticated user,
     * including completed activities and reflections.
     *
    ...
    public ResponseEntity<?> confirmSafety(@RequestParam String token) {
        try {
            ...
            return ResponseEntity.internalServerError()
                .body("En feil oppstod. Vennligst prøv igjen senere. / An error occurred. Please try again later.");
        }
    }

    /**
     * Initiates a safety confirmation request for all members of the user's household.
     * Each member will receive a unique confirmation token via email.
     *
     * @param principal the Principal object representing the current authenticated user
