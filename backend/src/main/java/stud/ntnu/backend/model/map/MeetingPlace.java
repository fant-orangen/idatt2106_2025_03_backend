...
/**
 * Represents a meeting place in the system. This entity stores information about physical locations
 * where users can meet, including geographical coordinates and metadata.
 */
@Entity
...
public class MeetingPlace {
  ...
  /**
   * Latitude coordinate of the meeting place. Stored with precision of 10 digits and 7 decimal
   * places.
   */
  ...
  /**
   * Longitude coordinate of the meeting place. Stored with precision of 10 digits and 7 decimal
   * places.
   */
  ...
  /**
   * Current status of the meeting place. Default value is "active".
   */
  ...
  /**
   * Timestamp when the meeting place was created. This field cannot be updated after creation.
   */
