...
/**
 * Represents a crisis event in the system.
 * This entity tracks information about crisis events including their location,
 * severity, timing, and associated metadata.
 */
@Entity
...
public class CrisisEvent {
    ...
    /**
     * Detailed description of the crisis event.
    ...
    /**
     * The radius of the affected area in the specified unit.
