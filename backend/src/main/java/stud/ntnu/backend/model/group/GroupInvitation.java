...
/**
 * Represents a group invitation entity in the system.
 * This entity tracks invitations sent to households for joining groups.
 * It maintains the state of the invitation including its creation, expiration,
 * acceptance, and decline timestamps.
 */
@Entity
...
public class GroupInvitation {
    ...
    /**
     * Unique identifier for the group invitation.
    ...
    /**
     * The group that the household is being invited to join.
    ...
    /**
     * The household that is being invited to join the group.
     * This is a required field and cannot be null.
     */
    @ManyToOne
     ...
     * After this time, the invitation can no longer be accepted.
     * This is a required field and cannot be null.
     */
    ...
    /**
     * The timestamp when the invitation was declined.
     * Null if the invitation has not been declined.
     */
     ...
     * This field is automatically set and cannot be updated after creation.
     */
     ...
     */
    public GroupInvitation(Group group, String inviterEmail, Household invitedHousehold, LocalDateTime expiresAt) {
        this.group = group;
    ...
    /**
     * Checks if the invitation is currently pending.
     * An invitation is considered pending if it has not been accepted or declined,
     * and has not expired.
     *
    ...
    /**
     * Accepts the invitation if it is currently pending.
     * Sets the acceptedAt timestamp to the current time.
     * This method has no effect if the invitation is not pending.
     */
    public void accept() {
        if (isPending()) {
    ...
    /**
     * Declines the invitation if it is currently pending.
