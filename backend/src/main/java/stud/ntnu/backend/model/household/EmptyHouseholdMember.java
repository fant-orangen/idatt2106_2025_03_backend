...
/**
 * Represents a non-user member of a household, such as a child, pet, or other dependent. These
 * members are stored in the household_member table and have their own nutritional requirements.
...
public class EmptyHouseholdMember {
  ...
  /**
   * Daily caloric requirement in kilocalories. Default value is 2000 kcal.
   */
