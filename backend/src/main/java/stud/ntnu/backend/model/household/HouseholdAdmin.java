...
/**
 * Represents an administrator of a household in the system. This entity maintains the relationship
 * between a user and their administrative role within a specific household.
 */
@Data
@NoArgsConstructor
@Entity
...
public class HouseholdAdmin {
  ...
  /**
   * The user who is an administrator of the household. Each user can only be an admin of one
   * household at a time.
   */
  ...
  /**
   * The household that this user administers. Multiple admins can be associated with a single
   * household.
   */
