...
/**
 * Represents a membership relationship between a Group and a Household. This entity tracks when a
 * household joins a group and when they leave.
 */
@Entity
...
public class GroupMembership {
  ...
  /**
   * Timestamp when the household joined the group. This field is automatically set and cannot be
   * updated.
   */
  ...
  /**
   * Timestamp when the household left the group. Null if the household is still a member.
   */
  @Column(name = "left_at")
