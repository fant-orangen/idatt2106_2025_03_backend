...
/**
 * Entity class representing a user's gamification activity in the system.
 * This class tracks a user's progress and completion status for specific gamification activities,
 * including scores and completion timestamps.
 */
@Entity
