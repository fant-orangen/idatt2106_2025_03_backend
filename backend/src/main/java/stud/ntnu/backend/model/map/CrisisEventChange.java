...
/**
 * Represents a change made to a crisis event in the system. This entity tracks modifications to
 * crisis events including the type of change, old and new values, and metadata about who made the
 * change and when.
 */
@Entity
...
public class CrisisEventChange {
  ...
  /**
   * The previous value before the change. Stored as TEXT in the database.
   */
  @Column(name = "old_value", columnDefinition = "TEXT")
  private String oldValue;

  /**
   * The new value after the change. Stored as TEXT in the database.
   */
   ...
   */
  public CrisisEventChange(CrisisEvent crisisEvent, ChangeType changeType, String oldValue,
      String newValue, User createdByUser) {
