...
/**
 * Represents a scenario theme in the system. This entity stores information about different
 * scenario themes including their descriptions, lifecycle stages (before, under, after), and
 * associated metadata.
 */
@Entity
...
public class ScenarioTheme {
  ...
  /**
   * The name of the scenario theme. Must be unique across all themes.
   */
  @Column(name = "name", nullable = false, unique = true)
  private String name;

  /**
   * Detailed description of the scenario theme. Stored as TEXT in the database.
   */
  @Column(name = "description", columnDefinition = "TEXT")
  private String description;

  /**
   * Description of the situation before the scenario. Stored as TEXT in the database.
   */
  @Column(name = "before", columnDefinition = "TEXT")
  private String before;

  /**
   * Description of the situation during the scenario. Stored as TEXT in the database.
   */
  @Column(name = "under", columnDefinition = "TEXT")
  private String under;

  /**
   * Description of the situation after the scenario. Stored as TEXT in the database.
   */
  ...
  /**
   * The timestamp when this scenario theme was created. This field cannot be updated after
   * creation.
   */
  ...
  /**
   * Current status of the scenario theme. Default value is "active".
   */
   ...
   * @param createdByUser The user creating this scenario theme
   */
  public ScenarioTheme(String name, String description, String before, String under, String after,
      User createdByUser) {
    this.name = name;
