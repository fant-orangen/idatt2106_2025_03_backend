...
/**
 * Represents an invitation entity in the system. This entity tracks invitations sent to users for
 * joining households or groups, including their status, expiration, and acceptance/decline
 * timestamps.
 */
@Entity
...
public class Invitation {
  ...
  /**
   * Timestamp when the invitation was created. Cannot be updated after creation.
   */
   ...
   * @param expiresAt    The expiration timestamp
   */
  public Invitation(User inviterUser, String inviteeEmail, Household household, String token,
  ...
  /**
   * Accepts the invitation if it is pending. Sets the acceptedAt timestamp to the current time.
   */
  public void accept() {
    if (isPending()) {
  ...
  /**
   * Declines the invitation if it is pending. Sets the declinedAt timestamp to the current time.
   */
  public void decline() {
    if (isPending()) {
