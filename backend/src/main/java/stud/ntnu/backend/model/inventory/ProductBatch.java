...
/**
 * Represents a batch of products in the inventory system.
 * Each batch is associated with a specific product type and contains information
 * about when it was added and when it expires.
 */
@Entity
...
public class ProductBatch {
     ...
     * Can be null if the product doesn't have an expiration date.
     */
