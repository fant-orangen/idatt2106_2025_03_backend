...
/**
 * Represents a news article in the system. This entity stores information about news articles
 * including their content, publication status, and associated metadata.
 */
@Setter
@Getter
@Entity
...
public class NewsArticle {
  ...
  /**
   * Enum representing the possible statuses of a news article. DRAFT: Article is in progress and
   * not yet published PUBLISHED: Article is live and visible to users ARCHIVED: Article is no
