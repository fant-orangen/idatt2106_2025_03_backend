 ...
 * This entity stores information about various types of notifications including their
 * target, timing, and delivery status.
 */
@Entity
...
public class Notification {
    ...
    /**
     * The type of target this notification is associated with.
     * Nullable for system notifications.
     */
    @Enumerated(EnumType.STRING)
