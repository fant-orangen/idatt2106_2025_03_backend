...
/**
 * Represents a household entity in the system.
 * A household is a collection of users living together at a specific location.
 * Each household has a name, address, population count, and optional geographical coordinates.
 */
@Entity
...
public class Household {
    ...
    /**
     * Physical address of the household.
     * Cannot be null and is stored as TEXT to accommodate long addresses.
     */
    ...
    /**
     * Latitude coordinate of the household's location.
     * Stored with 7 decimal places precision.
     */
    @Column(name = "latitude", precision = 10, scale = 7)
    private BigDecimal latitude;

    /**
     * Longitude coordinate of the household's location.
     * Stored with 7 decimal places precision.
     */
    ...
    /**
     * List of users associated with this household.
