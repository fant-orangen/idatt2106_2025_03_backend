...
/**
 * Entity class representing a user's notification preference settings. This class stores the user's
 * preferences for different types of notifications and tracks when these preferences were created
 * and last updated.
 */
@Data
@Entity
...
public class NotificationPreference {
  ...
  /**
   * Whether this notification type is enabled for the user. Defaults to true.
   */
