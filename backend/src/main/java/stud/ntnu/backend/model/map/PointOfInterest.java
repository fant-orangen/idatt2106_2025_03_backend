...
/**
 * Represents a point of interest on a map with its associated metadata. This entity stores
 * information about locations that users can interact with, including their geographical
 * coordinates, type, and operational details.
 */
@Entity
