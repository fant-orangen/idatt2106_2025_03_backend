...
public class TwoFactorCodeService {
    ...
    /**
     * Verifies the provided code against the one stored in the database for the given email.
     * If the code is valid and not expired, it deletes the code from the database.
     *
     * @param email The email address associated with the verification code.
