...
/**
 * Service for managing group inventory contributions and shared resources.
 * This service handles:
 * - Creation and management of group inventory contributions
 * - Product type and batch management within groups
 * - Access control for group inventory operations
 * - Search and retrieval of shared resources
 */
@Service
public class GroupInventoryService {
    ...
    /**
     * Adds a product batch to a group's shared inventory.
     * Performs several validation checks:
     * - Verifies that the batch exists
     * - Verifies that the group exists
     * - Checks if the batch is already contributed to another group
     * - Verifies that the user has permission to contribute the batch
     * - Ensures the batch belongs to the user's household
     *
