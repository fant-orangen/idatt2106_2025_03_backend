 ...
 * <p>
 * This DTO represents a quiz answer entity, containing information about the answer's content,
 * correctness, and its relationships to quizzes and questions.
 */
@Getter
@Setter
public class QuizAnswerDto {
   ...
   */
  public QuizAnswerDto(Long id, Long quizId, Long questionId, String answerBody, Boolean isCorrect,
