 ...
 * This class encapsulates notification data for transfer between layers of the application,
 * including details about the notification's target, timing, and status.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class NotificationDto {
     ...
     * including the conversion of enum types to their string representations.
     *
