...
/**
 * Data Transfer Object (DTO) for household invitation responses.
 * This class encapsulates the data returned when a household invitation is created,
 * including the invitation token, invitee details, and household information.
 */
@Getter
@Setter
public class HouseholdInviteResponseDto {
    ...
    /**
     * The unique token generated for this invitation.
     * This token is used to validate and process the invitation.
     */
