 ...
 * <p>
 * This DTO represents a meeting place in the system, including its geographical
 * location, address, and current status. It is used to transfer meeting place data
...
public class MeetingPlaceDto {
    ...
    /**
     * The latitude coordinate of the meeting place.
     * Represents the north-south position on Earth.
     */
    private BigDecimal latitude;
    
    /**
     * The longitude coordinate of the meeting place.
     ...
     * creating a data transfer object that can be safely sent to clients.
     *
