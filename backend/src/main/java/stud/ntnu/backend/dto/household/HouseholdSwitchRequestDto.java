...
/**
 * Data Transfer Object (DTO) for switching a user's active household. This class encapsulates the
 * data required to change a user's current household to a different one within their list of
 * households.
 */
@Setter
@Getter
public class HouseholdSwitchRequestDto {
  ...
  /**
   * The unique identifier of the household to switch to. This ID must correspond to a household
