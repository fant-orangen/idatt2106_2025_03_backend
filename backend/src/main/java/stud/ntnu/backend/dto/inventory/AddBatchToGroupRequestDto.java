...
/**
 * Data Transfer Object (DTO) for adding a batch to a group. This class represents the request
 * payload when adding a batch to a group in the inventory system.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
