...
/**
 * Data Transfer Object (DTO) representing an empty household member.
 * This class is used to transfer household member data without associated user information.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
