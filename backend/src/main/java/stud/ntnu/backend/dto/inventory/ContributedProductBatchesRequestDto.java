...
/**
 * Data Transfer Object (DTO) for requesting contributed product batches. This class represents the
 * request payload when retrieving batches of a specific product type that have been contributed to
 * a particular group.
 */
@Data
@NoArgsConstructor
