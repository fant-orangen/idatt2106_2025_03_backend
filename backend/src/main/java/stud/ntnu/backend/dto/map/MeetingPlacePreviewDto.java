 ...
 * <p>
 * This DTO contains essential information about a meeting place that is typically displayed in
 * preview or list views. It includes basic details such as the meeting place's identifier, name,
 * and current status.
 */
@Getter
@NoArgsConstructor
...
public class MeetingPlacePreviewDto {
   ...
   * <p>
   * This method maps the essential fields from the entity to the DTO, creating a simplified view of
   * the meeting place.
   *
