...
/**
 * Data Transfer Object (DTO) for representing household information. This class encapsulates all
 * relevant data about a household including its location, members, and basic information.
 */
@Getter
@Setter
