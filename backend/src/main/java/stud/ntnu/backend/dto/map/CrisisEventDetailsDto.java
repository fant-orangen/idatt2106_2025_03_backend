 ...
 * <p>
 * This DTO contains comprehensive information about a crisis event, including its geographical
 * location, temporal data, severity level, and associated scenario theme. It is used to transfer
 * detailed crisis event data between layers of the application.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class CrisisEventDetailsDto {
   ...
   * <p>
   * This method maps all relevant fields from the entity to the DTO, including the associated
   * scenario theme ID if present.
   *
