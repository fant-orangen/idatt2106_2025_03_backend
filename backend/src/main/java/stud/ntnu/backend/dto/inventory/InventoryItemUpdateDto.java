 ...
 * <p>
 * This class is used to transfer data when updating an item in the inventory. It contains
...
public class InventoryItemUpdateDto {
   ...
   */
  public InventoryItemUpdateDto(Integer productId, String customName, BigDecimal quantity,
