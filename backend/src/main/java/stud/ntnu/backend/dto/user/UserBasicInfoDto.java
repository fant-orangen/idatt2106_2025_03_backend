...
/**
 * Data Transfer Object (DTO) representing basic user information. This class encapsulates essential
 * user details including personal information and household association.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class UserBasicInfoDto {
  ...
  /**
   * Constructs a UserBasicInfoDto with basic user information. This constructor sets emailVerified
