 ...
 * <p>
 * This DTO contains fields for updating a scenario theme's properties. The ID field is required,
 * while all other fields are optional. If a field is null, the corresponding field in the existing
 * scenario theme will not be updated.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class UpdateScenarioThemeDto {
  ...
  /**
   * The unique identifier of the scenario theme to update. This field is required and cannot be
   * null.
   */
