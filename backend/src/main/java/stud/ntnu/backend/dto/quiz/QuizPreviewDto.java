...
/**
 * Data Transfer Object (DTO) representing a preview of a quiz. This class contains essential
 * information about a quiz that can be displayed in a list or preview context.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
