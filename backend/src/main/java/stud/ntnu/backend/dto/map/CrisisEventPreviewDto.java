 ...
 * <p>
 * This DTO contains essential information about a crisis event that is typically displayed in
 * preview or list views. It includes basic details such as the event's identifier, name, severity
