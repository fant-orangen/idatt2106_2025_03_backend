 ...
 * This class represents the data structure used for handling two-factor authentication
 * verification requests, containing the user's email and the verification code.
 */
@Getter
@Setter
