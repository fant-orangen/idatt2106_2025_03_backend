...
/**
 * Data Transfer Object (DTO) for updating a user's profile information. This class encapsulates the
 * fields that can be modified in a user's profile, including personal information and location
 * data.
 */
@Setter
@Getter
public class UserUpdateDto {
  ...
  /**
   * Default constructor for UserUpdateDto. Creates a new instance with default values.
   */
