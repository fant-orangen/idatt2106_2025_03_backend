 ...
 * <p>
 * This DTO contains all the necessary information required to create a new quiz answer, including
 * references to the quiz and question, the answer content, and its correctness.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
