...
/**
 * Data Transfer Object (DTO) for requesting contributed product types.
 * This class represents the request payload when retrieving product types
 * that have been contributed to a particular group, optionally filtered by category.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
