 ...
 * <p>
 * This DTO represents the changes made to a crisis event, including what was changed, who made the
 * change, and when the change occurred. It is used to track the history of modifications to crisis
...
public class CrisisEventChangeDto {
   ...
   * crisis event ID and user information.
   *
