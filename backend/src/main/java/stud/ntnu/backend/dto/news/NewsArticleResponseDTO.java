 ...
 * <p>
 * This DTO contains all the necessary information about a news article that needs to be
 * returned to the client, including its metadata, content, and relationships with other entities.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class NewsArticleResponseDTO {
     ...
     * <p>
     * This method maps all relevant fields from the NewsArticle entity to the DTO,
     * including nested information about the creator and associated crisis event.
     *
