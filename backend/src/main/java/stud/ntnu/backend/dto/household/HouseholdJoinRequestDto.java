...
/**
 * Data Transfer Object (DTO) representing a request to join a household.
 * This DTO contains the invitation token required to join a specific household.
 * The token is used to validate and process the join request.
 */
@Setter
@Getter
public class HouseholdJoinRequestDto {
    ...
    /**
     * The invitation token required to join a household.
     * This token is generated when creating a household invitation.
     */
