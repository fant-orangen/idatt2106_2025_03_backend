...
/**
 * Data Transfer Object (DTO) representing geographical coordinates. This class is used to transfer
 * latitude and longitude data between layers of the application.
 */
@Getter
@Setter
