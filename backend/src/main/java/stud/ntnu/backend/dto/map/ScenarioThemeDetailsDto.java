...
/**
 * Data Transfer Object (DTO) representing the details of a scenario theme.
 * This class is used to transfer scenario theme information between layers of the application.
 */
@Getter
@Setter
@NoArgsConstructor
