...
/**
 * Data Transfer Object (DTO) representing a reflection response.
 * This class encapsulates reflection data for transfer between layers of the application,
 * including user information, reflection content, and associated crisis event details.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class ReflectionResponseDto {
     ...
     * This method handles the conversion of entity-specific data types to their DTO representations,
     * including the extraction of user information and associated crisis event details.
     *
