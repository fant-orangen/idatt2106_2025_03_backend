...
/**
 * Data Transfer Object (DTO) for handling two-factor authentication (2FA) code requests.
 * This class encapsulates the email address required to send a 2FA code to a user.
...
public class Send2FACodeRequestDto {
    ...
    /**
     * The email address of the user requesting a 2FA code.
