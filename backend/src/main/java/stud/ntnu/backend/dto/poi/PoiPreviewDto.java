...
/**
 * Data Transfer Object (DTO) representing a preview of a Point of Interest (POI).
 * This class contains basic information about a POI that can be used for preview purposes.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
