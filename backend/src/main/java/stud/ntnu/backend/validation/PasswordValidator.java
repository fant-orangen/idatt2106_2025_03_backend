...
public class PasswordValidator {
  ...
  /**
   * Regular expression pattern for password validation. Matches strings that contain at least one
   * letter, one digit, one special character, and are at least 8 characters long.
   */
