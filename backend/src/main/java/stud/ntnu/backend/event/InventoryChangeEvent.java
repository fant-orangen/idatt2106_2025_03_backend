 ...
 * about low supplies or updating inventory statistics.
 *
 * <p>The event contains information about which household's inventory was changed
 * and what type of change occurred. This information can be used by listeners
 * to determine what actions to take in response to the change.</p>
 *
...
public class InventoryChangeEvent {
   ...
   * This ID is used to identify which household's inventory was affected
   * by the change event.
   */
