...
/**
 * Repository interface for managing HouseholdMember entities. Provides methods to query and
 * manipulate household member data.
 */
public interface HouseholdMemberRepository extends JpaRepository<HouseholdMember, Integer> {

  /**
   * Counts the number of household members in a specific household, excluding members of a certain
   * type.
   *
  ...
  Integer countByHouseholdIdAndTypeNot(@Param("householdId") Integer householdId,
