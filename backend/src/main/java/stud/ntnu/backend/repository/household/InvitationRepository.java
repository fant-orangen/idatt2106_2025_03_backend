...
/**
 * Repository interface for managing Invitation entities in the database.
 * Provides methods for querying and managing household invitations.
 */
@Repository
public interface InvitationRepository extends JpaRepository<Invitation, Integer> {
    ...
    /**
     * Retrieves all pending invitations for a household that haven't expired.
     * A pending invitation is one that hasn't been accepted or declined.
     *
