...
/**
 * Repository interface for managing CrisisEventChange entities.
 * Provides methods to interact with the database for crisis event change operations.
...
public interface CrisisEventChangeRepository extends JpaRepository<CrisisEventChange, Integer> {
    ...
    /**
     * Retrieves all changes associated with a specific crisis event, ordered by creation date in descending order.
