...
/**
 * Repository interface for managing PointOfInterest entities in the database. Provides methods for
 * basic CRUD operations and custom queries for point of interest data.
 */
@Repository
public interface PointOfInterestRepository extends JpaRepository<PointOfInterest, Integer> {
  ...
  /**
   * Updates an existing point of interest with new information. This method performs a direct
   * database update using a custom query.
   *
