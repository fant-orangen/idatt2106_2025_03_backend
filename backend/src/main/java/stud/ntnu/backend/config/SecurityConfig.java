        ...
        http
            ...
            .authorizeHttpRequests(auth ->
                auth.requestMatchers("/h2-console/**", "/swagger-ui/**", "/swagger-ui.html",
                    ...
                    .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/poi/**")
                    .permitAll()
                    ...
                    .requestMatchers("/api/super-admin", "/api/super-admin/**")
                    .hasAnyRole("SUPERADMIN")
                    .requestMatchers("/api/super-admin", "/api/super-admin//id-by-email/{email}")
                    .hasAnyRole("SUPERADMIN")
